...
const PROMO_RESPONSE: CampaignsPromotionsResponse = {
  ...
  incentive_categories: [{ label: 'Accesorii', qty: 20, value: 100 }], incentive_periods: [{ label: 'Mai', start_date: '2026-05-01', end_date: '2026-05-31', product_count: 2, reward_values: [5], qty: 20, potential: 120, value: 100 }], incentive_category_breakdown: [{ label: 'Accesorii', qty: 20, potential: 120, value: 100 }],
...
test.describe('Wave 2 Promo operator flow', () => {
  ...
  test('keeps partial status amber and preserves selection, sort and Excel action', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: 'Promo Iunie 2026' })).toBeVisible();
