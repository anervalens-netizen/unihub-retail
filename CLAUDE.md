...
- Comparatia simplificata, strict grila veche mai 2026 versus logica noua pe aceleasi vanzari/targete/zile, se genereaza cu `backend/venv/bin/python backend/scripts/generate_may_old_vs_new_grid.py` in `/opt/Mobiup/docs/comparatie_grila_veche_vs_noua_mai_2026.xlsx`.
