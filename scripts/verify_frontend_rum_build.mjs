...
const expectedDsn = process.env.VITE_GLITCHTIP_DSN || process.env.SENTRY_DSN || '';

if (!expectedDsn) {
  throw new Error('frontend RUM verification requires VITE_GLITCHTIP_DSN or SENTRY_DSN');
}
