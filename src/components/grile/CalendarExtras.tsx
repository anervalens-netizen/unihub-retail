...
export function CalendarExtras({ data, store, stores, writable }: { data: CalendarData; store: CalendarStore; stores: CalendarStore[]; writable: boolean }) {
  ...
  return <div className="space-y-3">
    <section className="overflow-hidden rounded-2xl border border-amber-200 dark:border-amber-800"><h4 className="bg-amber-700 px-3 py-2 font-bold text-white">Concedii · agenții magazinului</h4><div className="p-3">
