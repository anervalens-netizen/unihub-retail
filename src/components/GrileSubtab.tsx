...
export function GrileSubtab({ initialMonth }: { initialMonth?: string }) {
  ...
  return <div className="mx-auto max-w-6xl space-y-4 p-3 pb-24 pt-2 lg:max-w-none lg:p-0">
    <SegmentedTabs ariaLabel="Versiune grile" level="secondary" className="mx-auto w-full max-w-xs" options={[{ value: 'v1', label: 'v1' }, { value: 'v2', label: 'v2' }]} value={native ? 'v2' : 'v1'} onChange={value => setNative(value === 'v2')} />
