...
describe('SavedViewsControl', () => {
  beforeEach(() => {
    ...
    api.createSavedView.mockReset();
    api.deleteSavedView.mockReset().mockResolvedValue(undefined);
    api.toRetailContextUrlState.mockClear();
    vi.restoreAllMocks();
  });
  ...
  it('renders nothing for unsaveable Settings context', () => {
    const { container } = render(<SavedViewsControl currentState={null} mode="desktop" />);
