...
export function useTargetScenarioProjections({
  scenario, context, regionalFilter, selectedLocationCodes,
}: {
...
const displayWarnings = useMemo(
  ...
  return { regionals, locationOptions, selectedLocationSet, filteredRows, displaySourceMonths, tableTotals, sourceChart, regionalChart, regionalAllocation, activeSeasonalityLabel, displayWarnings };
}
