...
| H-06 BFF/server-side session | Implemented locally; production adoption pending | CI, merge, session secret provisioning and live login/logout verification |
...
2. complete H-06 review and production adoption;
...
H-06 remains open until production acceptance; H-01B and H-02 are operationally complete.
