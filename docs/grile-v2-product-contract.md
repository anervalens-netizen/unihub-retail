...
| BR-04 | Programul lunii următoare se pregătește cu câteva zile înainte de finalul lunii curente. Importul unui Excel cu toate magazinele trebuie să fie posibil; formatul concret urmează să fie stabilit. După import, managerul poate corecta calendarul. |
...
| BR-06 | `Grile` arată grilele agenților de bază ai magazinului, inclusiv câștigurile lor din suplimentări în alte locații. |
...
| BR-08 | Calendarul confirmat de manager determină cine primește vânzarea fizică magazin/zi. Reatribuirea schimbă creditul personal, fără să dubleze ori să mute totalul fizic al magazinului. |
...
| BR-11 | Fiecare alocare este legată explicit de codul agentului și de aceeași identitate stabilă a persoanei. Numele afișat și magazinul nu sunt suficiente pentru reunirea persoanei. |
...
| BR-16 | Produsul trebuie să rămână simplu și optimizat. Standalone se arhivează, pilotul vechi se retrage, iar V2 se construiește direct în Retail. Refolosim selectiv reguli și componente verificate. |
...
| D-02 | Formatul exact Excel pentru program și regulile importului repetat după corectări manuale. Recomandare: preview cu diferențe/conflicte și aplicare confirmată, fără agent AI obligatoriu în flux. |
...
| D-04 | Unicitatea codului agentului, transferurile, schimbarea magazinului de bază și cazul lucrului între firme/regiuni. Definirea firmei de salarizare evită dublarea persoanei în foile Mobiup/Mobicell. |
