...
async def load_inputs(
    ...
    *,
    ...
    if include_salary_history:
        ...
        # This view excludes ambiguous source versions and any company-month
        # already covered by salary_records. Net + vouchers stays a model input,
        # never a direct replacement for Finance employer cost (category c3).
        ...
        salaries = [*salaries, *historical_salaries]
