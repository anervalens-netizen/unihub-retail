...
## Migrațiile aditive ale P0

Baseline-ul `schema_v2.sql` și migrațiile 001–031 rămân imutabile. La SHA-ul P0 `f9c0b1efe15686bcda532d22528e6e2644925aec`, manifestul include următoarele delta-uri aditive:
...
Aplicarea se face numai prin `unihub-retail-migrate.service`, cu `MIGRATION_DATABASE_URL`, backup/read-only reconciliation și verificarea checksumului. Nu edita 032–034 după aplicare; corecția este o migrare nouă.
