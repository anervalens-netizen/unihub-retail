...
def test_sensitive_routes_keep_named_rate_limit_dependencies() -> None:
    ...
    expected = {
        ...
        ("POST", "/api/grile/monthly/manifests/{manifest_id}/approve"): "rate_limit_grile_job",
        ("POST", "/api/grile/agent-targets/diff"): "rate_limit_grile_job",
        ("POST", "/api/grile/agent-targets/sync"): "rate_limit_grile_job",
